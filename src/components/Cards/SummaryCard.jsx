    ...
    >
      ...
      <div className="px-3 pb-3">
        <div className="flex items-center gap-3 mt-4">
            <div className="text-[11px] font-medium text-black px-3 py-1 border-[2px] border-gray-900 rounded-full">
                Experience: {experience} {experience == 1 ? "Year" : "Years"}
            </div>

            <div className="text-[11px] font-medium text-black py-1 px-3 border-[2px] border-gray-900 rounded-full">
                {questions} Q&A
            </div>
